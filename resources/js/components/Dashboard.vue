                ...
                <div class="row m-3 p-0">
                    <div class="col-12 px-0 pb-3 upcoming_page">
                        ...
                        <div class="row item_title">
                            ...
                            <div class="title_colname_s title_text">
                                寵物姓名
                            </div>
                            <div class="title_colname_s title_text">
                                寵物性別
                            ...
                            <div class="title_colname_m title_text">
                                診前備註
                            </div>
                            <div class="title_colname_m title_text">
                                電話號碼
                        ...
                        >
                            ...
                            <div class="record_content_m">
                                <button @click="openRecord(item.customer_id)">
                                    紀錄
                                </button>
                            </div>
                            <div class="record_content_m">
                                <button v-on:click="startDiagnosis(index)">
                                    開始看診
                                </button>
                            </div>
                            <div
                            ...
                            >
                                <div
                                    v-if="
                                        item.isOpenRecord != undefined &&
                                        item.isOpenRecord == true
                                    "
                                >
                                    <div class="record_content_s">
                                        {{ record.date }}
...
export default {
    ...
    methods: {
        openRecord(customer_id) {
            let clinic_id = "1";
            const vm = this;
            httpAPI
                .getDiagnosisRecord(clinic_id, customer_id)
        ...
        getReservation(today) {
            const vm = this;
            httpAPI
                .getReservation(this.clinic_id, today)
                .then(function (response) {
        ...
        getDiagnosisInfo(today) {
            const vm = this;
            httpAPI
                .getDiagnosisInfo(this.clinic_id, today)
                .then(function (response) {
                    vm.doctor_diagnosis_list = response.data;
                    vm.doctor_diagnosis_list.forEach((object) => {
